...
import com.dty.objectif_dty.service.MailService;
import com.dty.objectif_dty.service.UserService;
import com.dty.objectif_dty.web.rest.dto.KeyAndPasswordDTO;
import com.dty.objectif_dty.web.rest.dto.ManagedUserDTO;
import com.dty.objectif_dty.web.rest.dto.UserDTO;
        ...
        return userRepository.findOneByLogin(managedUserDTO.getLogin().toLowerCase())
            ...
            .orElseGet(() -> userRepository.findOneByEmail(managedUserDTO.getEmail())
                ...
                .orElseGet(() -> {
                    ...
                    managedUserDTO.getLangKey(), managedUserDTO.isActivated(), managedUserDTO.getAuthorities());
